...
「P1 は OpenClaw 外部コアとして、自己改変・外界観測・bounded 外界アクション・会話の 4 要素を最小形で備えた。OpenClaw 側は薄い control plane のまま維持し、比較・監査・rollback 可能な運用ループまで実装済み。」
