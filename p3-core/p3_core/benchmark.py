...
from p3_core.workspace import WorkspacePaths, bootstrap_workspace, now_iso, read_json, read_jsonl, write_json
...
BENCHMARK_CASES: tuple[BenchmarkCase, ...] = (
    ...
    BenchmarkCase(
        ...
        expected_fragments=("p3-core", "p1-core"),
...
def _run_case(
    ...
    *,
    ...
    with tempfile.TemporaryDirectory(prefix="p3-bench-") as tmp:
